...
egg = 1 / 24
mjol = 230 / 24
cookies = int(input("Hvor mange cookies ønsker du å bage? "))
print(f"Antall cookies: {cookies}")
print(f"Sukker (g): {cookies*sukker}")
print(f"Smør (g) : {cookies*smor}")
print(f"Sjokolade (plater) : {cookies*sjokolade}")
print(f"Egg: {cookies*egg}")
print(f"Mjæl (g): {cookies*mjol}")
